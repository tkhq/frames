 ...
 */
export function fromDerSignature(derSignature: any): Uint8Array;
/**
 ...
 */
export function verifyEnclaveSignature(enclaveQuorumPublic: string, publicSignature: string, signedData: string): Promise<any>;
/**
 ...
 */
export function encodeKey(privateKeyBytes: Uint8Array, keyFormat?: string, publicKeyBytes?: Uint8Array): Promise<string>;
export function parsePrivateKey(privateKey: any): Uint8Array;
/**
 ...
 * @return {Object}
 */
export function validateStyles(styles: any, element?: HTMLElement): any;
